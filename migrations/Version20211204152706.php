 ...
 */
final class Version20211204152706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artisan CHANGE mdp mdp VARCHAR(128) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3C600AD35126AC48 ON artisan (mail)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3C600AD35126AC48 ON artisan');
        $this->addSql('ALTER TABLE artisan CHANGE mdp mdp VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
