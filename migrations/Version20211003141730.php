 ...
 */
final class Version20211003141730 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE postulant ADD CONSTRAINT FK_F79395124CC8505A FOREIGN KEY (offre_id) REFERENCES offre (id)');
